...
APPNAME=mtb-example-fx2g3-canfd-interface
...
ifeq ($(filter $(subst -,_,$(DEVICE)),CYUSB2318_BF104AXI CYUSB2317_BF104AXI CYUSB2316_BF104AXI),)
...
# Set CORE to CM0P if DEVICE is not CYUSB2318_BF104AXI
ifneq ($(subst -,_,$(DEVICE)),CYUSB2318_BF104AXI)
CORE=CM0P
endif
